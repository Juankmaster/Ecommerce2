...
* fix: A small fix to work with PHP 5.3.*. **We strongly recommend you to check you PHP version** and update if that's needed, more info https://wordpress.org/about/requirements/. It's good for your WordPress security and performance.
